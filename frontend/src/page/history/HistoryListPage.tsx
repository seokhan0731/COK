...
const HistoryListPage = () => {
    ...
    return (
        <div className="flex flex-col gap-6 px-4 sm:px-6 mt-6 mb-10">
            ...
            {historyList?.map((item, index) => {
                ...
                return (
                    <div key={item.sessionId} className="flex items-center gap-3 lg:gap-4 bg-card-background rounded-2xl border border-border px-4 py-4 lg:px-6 lg:py-5">
